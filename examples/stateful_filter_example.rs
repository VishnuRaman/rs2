...
async fn main() {
    ...
    let filtered_results: Vec<Transaction> = rs2_stream::rs2::from_iter_rs2(transactions.clone())
        .stateful_filter_rs2(
            StateConfig::default(),
    ...
    let frequency_results: Vec<Transaction> = rs2_stream::rs2::from_iter_rs2(transactions.clone())
        .stateful_filter_rs2(
            StateConfig::default(),
            CustomKeyExtractor::new(|transaction: &Transaction| transaction.user_id.clone()),
            |transaction, state_access| {
    ...
    let category_results: Vec<Transaction> = rs2_stream::rs2::from_iter_rs2(transactions.clone())
        .stateful_filter_rs2(
            StateConfig::default(),
            CustomKeyExtractor::new(|transaction: &Transaction| transaction.user_id.clone()),
            |transaction, state_access| {
    ...
    let time_results: Vec<Transaction> = rs2_stream::rs2::from_iter_rs2(transactions.clone())
        .stateful_filter_rs2(
            StateConfig::default(),
            CustomKeyExtractor::new(|transaction: &Transaction| transaction.user_id.clone()),
            |transaction, state_access| {
