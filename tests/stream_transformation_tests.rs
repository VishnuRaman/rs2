...
fn test_zip_with() {
    ...
    rt.block_on(async {
        ...
        let result2 = s3.zip_with_rs2(s4, |a, b| format!("{}-{}", a, b)).collect::<Vec<_>>().await;
...
fn test_distinct_until_changed_by() {
    ...
    rt.block_on(async {
        ...
        // Using the function directly
        let result1 = distinct_until_changed_by(s1, |a, b| a % 2 == b % 2).collect::<Vec<_>>().await;
        assert_eq!(result1, vec![1, 2, 5, 6]);

        // Using the extension trait
        let s2 = from_iter(vec![1, 3, 2, 4, 5, 7, 6, 8]);
        let result2 = s2.distinct_until_changed_by_rs2(|a, b| a % 2 == b % 2).collect::<Vec<_>>().await;
...
fn test_group_adjacent_by() {
    ...
    rt.block_on(async {
        ...
        // Using the extension trait
        let s2 = from_iter(vec![1, 3, 2, 4, 5, 7, 6, 8]);
        let result2 = s2.group_adjacent_by_rs2(|&x| x % 2).collect::<Vec<_>>().await;
...
fn test_interrupt_when() {
    ...
    rt.block_on(async {
        ...
        let stream = from_iter(0..100)
            .throttle_rs2(Duration::from_millis(50));
        ...
        assert!(result1.len() >= 3 && result1.len() <= 4, 
                "Expected 3-4 items, got {}", result1.len());
        ...
        assert!(result2.len() >= 3 && result2.len() <= 4, 
                "Expected 3-4 items, got {}", result2.len());
...
fn test_interrupt_when_immediate() {
    ...
    rt.block_on(async {
        ...
        assert!(result.len() < 3, "Expected fewer than 3 items, got {}", result.len());
...
fn test_interrupt_when_completed_stream() {
    ...
    fn test_either_with_different_timing() {
        ...
        rt.block_on(async {
            ...
            assert!(result.contains(&1) && result.contains(&2) && result.contains(&10) && result.contains(&20));
        });
    }
    ...
    fn test_either_with_empty_stream() {
        ...
        rt.block_on(async {
            ...
            let result1 = either(empty_stream, non_empty_stream).collect::<Vec<_>>().await;
            ...
            let result2 = either(empty_stream1, empty_stream2).collect::<Vec<_>>().await;
    ...
    fn test_filter_map_all_filtered() {
        ...
        rt.block_on(async {
            ...
            let result = filter_map(numbers, |_| async move {
                None::<i32>
            }).collect::<Vec<_>>().await;
    ...
    fn test_group_by_complex_key() {
        ...
        rt.block_on(async {
            ...
            let result = group_by(words, |s| s.chars().next().unwrap()).collect::<Vec<_>>().await;
    ...
    fn test_take_while_basic() {
        ...
        rt.block_on(async {
            ...
            let result = take_while(numbers, |&x| async move { x < 4 }).collect::<Vec<_>>().await;
    ...
    fn test_take_while_empty_stream() {
        ...
        rt.block_on(async {
            ...
            let result = take_while(empty, |&x| async move { x < 4 }).collect::<Vec<_>>().await;
    ...
    fn test_take_while_all_taken() {
        ...
        rt.block_on(async {
            ...
            let result = take_while(numbers, |_| async move { true }).collect::<Vec<_>>().await;
    ...
    fn test_take_while_none_taken() {
        ...
        rt.block_on(async {
            ...
            let result = take_while(numbers, |_| async move { false }).collect::<Vec<_>>().await;
    ...
    fn test_drop_while_basic() {
        ...
        rt.block_on(async {
            ...
            let result = drop_while(numbers, |&x| async move { x < 4 }).collect::<Vec<_>>().await;
    ...
    fn test_drop_while_empty_stream() {
        ...
        rt.block_on(async {
            ...
            let result = drop_while(empty, |&x| async move { x < 4 }).collect::<Vec<_>>().await;
    ...
    fn test_drop_while_all_dropped() {
        ...
        rt.block_on(async {
            ...
            let result = drop_while(numbers, |_| async move { true }).collect::<Vec<_>>().await;
    ...
    fn test_drop_while_none_dropped() {
        ...
        rt.block_on(async {
            ...
            let result = drop_while(numbers, |_| async move { false }).collect::<Vec<_>>().await;
